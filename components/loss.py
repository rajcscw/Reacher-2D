...
class InverseKinematic:
    ...
    def plot(self, l1, l2, l3, initial=False):
        """
        plot the arms
    ...
    def run_episode(self, model, params, eval, filename):
        ...
        if eval:
            ...
            circle1 = plt.Circle((target[0], target[1]), 0.5, color='g')
        ...
        for i in range(episode_length):
            ...
            # do a forward pass
            input = np.array([l1[0], l1[1], l2[0], l2[1], l3[0], l3[1], d1[0], d1[1], d2[0], d2[1], target[0], target[1]]).reshape((1,-1))
